...
const sendgridData: BlastRadiusServiceData = {
  ...
  scopes: [
    ...
    { scope: 'Category Management', sub_scope: '', access: 'Read & Write', permissions: ['categories.create', 'categories.delete', 'categories.read', 'categories.update'] },
    ...
    { scope: 'Mail Settings', sub_scope: 'Event Notification', access: 'Read & Write', permissions: ['user.webhooks.event.settings.read', 'user.webhooks.event.settings.update'] },
    ...
    { scope: 'Suppressions', sub_scope: 'Suppressions', access: 'Read & Write', permissions: ['suppression.blocks.create', 'suppression.blocks.delete', 'suppression.blocks.read', 'suppression.blocks.update'] },
    ...
    { scope: 'Template Engine', sub_scope: '', access: 'Read & Write', permissions: ['templates.create', 'templates.delete', 'templates.read', 'templates.update'] },
